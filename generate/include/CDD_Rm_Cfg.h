...
#include "CDD_Rm_VS_HEADLESS_PBcfg.h"
...
#define RM_CFG_SW_MAJOR_VERSION                4
#define RM_CFG_SW_MINOR_VERSION                0
#define RM_CFG_SW_PATCH_VERSION                2
/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
...
#endif
/* Checks against CDD_Rm_VS_HEADLESS_PBcfg.h */
#if (RM_CFG_VENDOR_ID != RM_PBCFG_VS_HEADLESS_VENDOR_ID)
    #error "CDD_Rm_Cfg.h and CDD_Rm_VS_HEADLESS_PBcfg.h have different vendor ids"
#endif
#if ((RM_CFG_AR_RELEASE_MAJOR_VERSION    != RM_PBCFG_VS_HEADLESS_AR_RELEASE_MAJOR_VERSION) || \
     (RM_CFG_AR_RELEASE_MINOR_VERSION    != RM_PBCFG_VS_HEADLESS_AR_RELEASE_MINOR_VERSION) || \
     (RM_CFG_AR_RELEASE_REVISION_VERSION != RM_PBCFG_VS_HEADLESS_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of CDD_Rm_Cfg.h and CDD_Rm_VS_HEADLESS_PBcfg.h are different"
#endif
#if ((RM_CFG_SW_MAJOR_VERSION != RM_PBCFG_VS_HEADLESS_SW_MAJOR_VERSION) || \
     (RM_CFG_SW_MINOR_VERSION != RM_PBCFG_VS_HEADLESS_SW_MINOR_VERSION) || \
     (RM_CFG_SW_PATCH_VERSION != RM_PBCFG_VS_HEADLESS_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of CDD_Rm_Cfg.h and CDD_Rm_VS_HEADLESS_PBcfg.h are different"
#endif
...
*
*/
#define RM_GET_VERSION_INFO_API                 (STD_ON)
...
/*********************************** MPU_M7 SECTION *******************************/
#define RM_ENABLE_MPU_M7                              (STD_ON)
/*********************************** MULTICORE SECTION ****************************/
#define RM_MPU_M7_MULTICORE_SUPPORT                   (STD_OFF)
/*********************************** MSCM SECTION *********************************/
