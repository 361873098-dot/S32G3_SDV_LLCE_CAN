...
#define MCU_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION_C      4
#define MCU_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define MCU_VS_0_PBCFG_SW_MAJOR_VERSION_C              4
#define MCU_VS_0_PBCFG_SW_MINOR_VERSION_C              0
#define MCU_VS_0_PBCFG_SW_PATCH_VERSION_C              2
