...
==================================================================================================*/
/**
*   @file       Power_Ip_VS_HEADLESS_PBcfg.c
*   @version    4.0.2
*
...
==================================================================================================*/
#define POWER_IP_VS_HEADLESS_PBCFG_VENDOR_ID_C                      43
#define POWER_IP_VS_HEADLESS_PBCFG_AR_RELEASE_MAJOR_VERSION_C       4
#define POWER_IP_VS_HEADLESS_PBCFG_AR_RELEASE_MINOR_VERSION_C       4
#define POWER_IP_VS_HEADLESS_PBCFG_AR_RELEASE_REVISION_VERSION_C    0
#define POWER_IP_VS_HEADLESS_PBCFG_SW_MAJOR_VERSION_C               4
#define POWER_IP_VS_HEADLESS_PBCFG_SW_MINOR_VERSION_C               0
#define POWER_IP_VS_HEADLESS_PBCFG_SW_PATCH_VERSION_C               2

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if source file and Power_Ip.h file are of the same vendor */
#if (POWER_IP_VS_HEADLESS_PBCFG_VENDOR_ID_C != POWER_IP_CFG_VENDOR_ID)
    #error "Power_Ip_VS_HEADLESS_PBcfg.c and Power_Ip_Cfg.h have different vendor ids"
#endif
/* Check if source file and Power_Ip_Cfg.h file are of the same Autosar version */
#if ((POWER_IP_VS_HEADLESS_PBCFG_AR_RELEASE_MAJOR_VERSION_C != POWER_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (POWER_IP_VS_HEADLESS_PBCFG_AR_RELEASE_MINOR_VERSION_C != POWER_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     (POWER_IP_VS_HEADLESS_PBCFG_AR_RELEASE_REVISION_VERSION_C != POWER_IP_CFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Power_Ip_VS_HEADLESS_PBcfg.c and Power_Ip_Cfg.h are different"
#endif
/* Check if source file and Power_Ip_Cfg.h file are of the same Software version */
#if ((POWER_IP_VS_HEADLESS_PBCFG_SW_MAJOR_VERSION_C != POWER_IP_CFG_SW_MAJOR_VERSION) || \
     (POWER_IP_VS_HEADLESS_PBCFG_SW_MINOR_VERSION_C != POWER_IP_CFG_SW_MINOR_VERSION) || \
     (POWER_IP_VS_HEADLESS_PBCFG_SW_PATCH_VERSION_C != POWER_IP_CFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Power_Ip_VS_HEADLESS_PBcfg.c and Power_Ip_Cfg.h are different"
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
/* Check if source file and StandardTypes.h file are of the same Autosar version */
#if ((POWER_IP_VS_HEADLESS_PBCFG_AR_RELEASE_MAJOR_VERSION_C != STD_AR_RELEASE_MAJOR_VERSION) || \
     (POWER_IP_VS_HEADLESS_PBCFG_AR_RELEASE_MINOR_VERSION_C != STD_AR_RELEASE_MINOR_VERSION) \
    )
    #error "AutoSar Version Numbers of Power_Ip_VS_HEADLESS_PBcfg.c and StandardTypes.h are different"
#endif
...
static const Power_Ip_MC_ME_CoreConfigType Power_Ip_MC_ME_aPartition0CoreConfigPB_0_VS_HEADLESS[4U] =
{
...
static const Power_Ip_MC_ME_CoreConfigType Power_Ip_MC_ME_aPartition1CoreConfigPB_0_VS_HEADLESS[8U] =
{
...
static const Power_Ip_MC_ME_CofbConfigType Power_Ip_MC_ME_aPartition0CofbConfigPB_0_VS_HEADLESS[1U] = 
{
...
static const Power_Ip_MC_ME_CofbConfigType Power_Ip_MC_ME_aPartition2CofbConfigPB_0_VS_HEADLESS[1U] = 
{
...
static const Power_Ip_MC_ME_PartitionConfigType Power_Ip_MC_ME_aPartitionConfigPB_0_VS_HEADLESS[4U] = 
{
    /* The configuration structure for Partition 0. */
    {
        ...
        &Power_Ip_MC_ME_aPartition0CofbConfigPB_0_VS_HEADLESS,

        /* Number of Cores within Partition 0 */
        (uint8)4U,
        /* Configuration for the Cores within Partition 0. */
        &Power_Ip_MC_ME_aPartition0CoreConfigPB_0_VS_HEADLESS
    },
    ...
    /* The configuration structure for Partition 1. */
    {
        ...
        &Power_Ip_MC_ME_aPartition1CoreConfigPB_0_VS_HEADLESS
    },
    ...
    /* The configuration structure for Partition 2. */
    {
        ...
        &Power_Ip_MC_ME_aPartition2CofbConfigPB_0_VS_HEADLESS,
...
*/
static const Power_Ip_MC_ME_ModeConfigType Power_Ip_MC_ME_ModeConfigPB_0_VS_HEADLESS =
{
    ...
    &Power_Ip_MC_ME_aPartitionConfigPB_0_VS_HEADLESS
};

static const Power_Ip_MC_RGM_CoreConfigType Power_Ip_MC_RGM_aDomain0CoreConfigPB_0_VS_HEADLESS[4U] = 
{
...
static const Power_Ip_MC_RGM_CoreConfigType Power_Ip_MC_RGM_aDomain1CoreConfigPB_0_VS_HEADLESS[8U] = 
{
...
static const Power_Ip_MC_RGM_CofbConfigType Power_Ip_MC_RGM_aDomain0CofbConfigPB_0_VS_HEADLESS[1U] =
{
...
static const Power_Ip_MC_RGM_DomainConfigType Power_Ip_MC_RGM_aDomainConfigPB_0_VS_HEADLESS[4U] =
{
    /* The configuration structure for Domain 0. */
    {
        ...
        &Power_Ip_MC_RGM_aDomain0CofbConfigPB_0_VS_HEADLESS,

        /* Number of Cores within Domain 0 */
        (uint8)4U,
        /* Configuration for the Cores within Domain 0. */
        &Power_Ip_MC_RGM_aDomain0CoreConfigPB_0_VS_HEADLESS
    },
    /* The configuration structure for Domain 1. */
    {
        ...
        &Power_Ip_MC_RGM_aDomain1CoreConfigPB_0_VS_HEADLESS
    },
...
*                   Data set and configured by Mcu_SetMode call.
*/
static const Power_Ip_MC_RGM_ModeConfigType Power_Ip_MC_RGM_ModeConfigPB_0_VS_HEADLESS =
{
    /* MC_RGM Mode Domain Settings. */
    &Power_Ip_MC_RGM_aDomainConfigPB_0_VS_HEADLESS
};
...
*
*/
const Power_Ip_ModeConfigType Power_Ip_aModeConfigPB_VS_HEADLESS[1U] =
{
    ...
    /* Start of Mcu_aModeConfig[0] */
    {
        ...
        &Power_Ip_MC_ME_ModeConfigPB_0_VS_HEADLESS,
        /* MC_RGM IP Mode settings. */
        &Power_Ip_MC_RGM_ModeConfigPB_0_VS_HEADLESS
...
*
*/
static const Power_Ip_MC_RGM_ConfigType Power_Ip_MC_RGM_ConfigPB_VS_HEADLESS =
{
...
*
*/
static const Power_Ip_PMC_ConfigType Power_Ip_PMC_ConfigPB_VS_HEADLESS =
{
...
*
*/
const Power_Ip_HwIPsConfigType Power_Ip_HwIPsConfigPB_VS_HEADLESS =
{
    /* Configuration for MC_RGM (Reset Generation Module) hardware IP. */
    &Power_Ip_MC_RGM_ConfigPB_VS_HEADLESS,

    /* Configuration for PMU (Power Management Unit) hardware IP, part of PCU. */
    &Power_Ip_PMC_ConfigPB_VS_HEADLESS,
};
