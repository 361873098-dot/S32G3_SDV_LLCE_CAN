...
*/
#ifndef LLCE_INTERFACE_STATIC_ASSERT
#define LLCE_INTERFACE_STATIC_ASSERT(condition) extern uint8 LLCE_CHECK_TYPE_SIZE[(condition) ? 1 : -1]
#endif

LLCE_INTERFACE_STATIC_ASSERT(sizeof(Can_Af_DestRulesType) == 64U);
LLCE_INTERFACE_STATIC_ASSERT(sizeof(MEMBER_OF(Can_Af_DestRulesType,AfDest)) == 60U);
...
LLCE_INTERFACE_STATIC_ASSERT(offsetof(Can_Af_DestRulesType,eAfDestId) == 60U);
...
LLCE_INTERFACE_STATIC_ASSERT(sizeof(Llce_Can_Can2EthRoutingTableType) == 60U);
...
LLCE_INTERFACE_STATIC_ASSERT(sizeof(MEMBER_OF(Llce_Can_Can2EthRoutingTableType,u8Can2EthDstIp)) == 16U);
LLCE_INTERFACE_STATIC_ASSERT(offsetof(Llce_Can_Can2EthRoutingTableType,u8Can2EthDstIp) == 20U);
LLCE_INTERFACE_STATIC_ASSERT(sizeof(MEMBER_OF(Llce_Can_Can2EthRoutingTableType,u8Can2EthSrcIp)) == 16U);
LLCE_INTERFACE_STATIC_ASSERT(offsetof(Llce_Can_Can2EthRoutingTableType,u8Can2EthSrcIp) == 36U);
LLCE_INTERFACE_STATIC_ASSERT(sizeof(MEMBER_OF(Llce_Can_Can2EthRoutingTableType,u8Can2EthDstPort)) == 2U);
LLCE_INTERFACE_STATIC_ASSERT(offsetof(Llce_Can_Can2EthRoutingTableType,u8Can2EthDstPort) == 52U);
LLCE_INTERFACE_STATIC_ASSERT(sizeof(MEMBER_OF(Llce_Can_Can2EthRoutingTableType,u8Can2EthSrcPort)) == 2U);
LLCE_INTERFACE_STATIC_ASSERT(offsetof(Llce_Can_Can2EthRoutingTableType,u8Can2EthSrcPort) == 54U);
LLCE_INTERFACE_STATIC_ASSERT(sizeof(MEMBER_OF(Llce_Can_Can2EthRoutingTableType,u16Can2EthPhyIfList)) == 2U);
LLCE_INTERFACE_STATIC_ASSERT(offsetof(Llce_Can_Can2EthRoutingTableType,u16Can2EthPhyIfList) == 56U);
...
LLCE_INTERFACE_STATIC_ASSERT(sizeof(MEMBER_OF(Llce_Can_CommandListType,CreateAfDest)) == 68U);
...
LLCE_INTERFACE_STATIC_ASSERT(sizeof(Llce_Can_CreateAfDestination) == 68U);
LLCE_INTERFACE_STATIC_ASSERT(sizeof(MEMBER_OF(Llce_Can_CreateAfDestination,rule)) == 64U);
...
LLCE_INTERFACE_STATIC_ASSERT(offsetof(Llce_Can_CreateAfDestination,u8Idx) == 64U);
...
LLCE_INTERFACE_STATIC_ASSERT(LLCE_HEADLESS_SUCCESS == 105U);
LLCE_INTERFACE_STATIC_ASSERT(LLCE_HEADLESS_INITPLATFORM_ERROR == 106U);
LLCE_INTERFACE_STATIC_ASSERT(LLCE_HEADLESS_INITCTRL_ERROR == 107U);
LLCE_INTERFACE_STATIC_ASSERT(LLCE_HEADLESS_CREATEDESTINATIONS_ERROR == 108U);
LLCE_INTERFACE_STATIC_ASSERT(LLCE_HEADLESS_SETFILTER_ERROR == 109U);
LLCE_INTERFACE_STATIC_ASSERT(LLCE_HEADLESS_SETADVANCEDFILTER_ERROR == 110U);
LLCE_INTERFACE_STATIC_ASSERT(LLCE_FW_RETURNTYPE_COUNT == 111U);
...
LLCE_INTERFACE_STATIC_ASSERT(LLCE_HEADLESS_TX == 117U);
LLCE_INTERFACE_STATIC_ASSERT(LLCE_HEADLESS_RX == 118U);
LLCE_INTERFACE_STATIC_ASSERT(LLCE_HEADLESS_FRPE == 119U);
...
LLCE_INTERFACE_STATIC_ASSERT(LLCE_AF_CAN2UDP_IPV6 == 6U);
LLCE_INTERFACE_STATIC_ASSERT(LLCE_AF_CAN2UDP_B_IPV6 == 7U);
LLCE_INTERFACE_STATIC_ASSERT(LLCE_AF_CAN2ETH_FORMAT_MAX == 8U);
