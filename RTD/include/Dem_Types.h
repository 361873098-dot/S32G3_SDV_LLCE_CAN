...
#define DEM_TYPES_AR_RELEASE_MINOR_VERSION      4
#define DEM_TYPES_AR_RELEASE_REVISION_VERSION   0
#define DEM_TYPES_SW_MAJOR_VERSION              4
#define DEM_TYPES_SW_MINOR_VERSION              0
#define DEM_TYPES_SW_PATCH_VERSION              2
